...
if (!empty($_POST['edit_svmk']))
{
     // Lay data
         //-------------Minh sửa
     $data['Mk']         = isset($_POST['pass']) ? $_POST['pass'] : '';
        //-------------
...
<html>
    ...
    <!-- //-------------đây nx -->
        <form method="post" action="gvmk_edit.php?id=<?php echo $data['ID_user']; ?>">
     <!-- //--------------->  
        <h1>Change password</h1>
            <a href="javascript:history.back()">Trở về</a> <br/> <br/>

            <table width="50%">
                <tr>
                    <td>
                    <!-- //-------------đây nx --> 
                        <input placeholder="New password" class="ip3" type="text" name="pass"/>
                     <!-- //--------------->  
            ...
            <input id="ip2" type="submit" name="edit_svmk" value="Lưu"/>
        </form>
    </section>
    </body>
</html>
